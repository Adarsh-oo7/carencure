...
const suburbs = [
  ...
  { name: 'Claremont', href: '/locations' },
  { name: 'Mount Lawley', href: '/locations/mount-lawley' },
  { name: 'Inglewood', href: '/locations' },
  ...
  { name: 'Booragoon', href: '/locations' },
  { name: 'Canning Vale', href: '/locations' },
  ...
  { name: 'Wembley', href: '/locations' },
  { name: 'Floreat', href: '/locations' },
  { name: 'Mount Pleasant', href: '/locations' },
  { name: 'Leederville', href: '/locations' },
  { name: 'Victoria Park', href: '/locations' },
]
